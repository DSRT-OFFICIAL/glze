...
/**
 * GlazeVector3 - versi unik dari Vector3.
 * Semua method dan fungsionalitas sama seperti Vector3.
 */
class GlazeVector3 {
	...
	constructor(x = 0, y = 0, z = 0) {
		...
		// flag untuk type checking
		GlazeVector3.prototype.isVector3 = true;
	...
	projectOnPlane(planeNormal) { _vector.copy(this).projectOnVector(planeNormal); return this.sub(_vector); }
	...
	randomDirection(){ const theta=Math.random()*Math.PI*2; const u=Math.random()*2-1; const c=Math.sqrt(1-u*u); this.x=c*Math.cos(theta); this.y=u; this.z=c*Math.sin(theta); return this; }
	*[Symbol.iterator](){ yield this.x; yield this.y; yield this.z; }

}

// internal helpers
const _vector = new GlazeVector3();
