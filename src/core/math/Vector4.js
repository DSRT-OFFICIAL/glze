export class Vector4 {
  ...
  multiplyComponents(v){ return new Vector4(this.x*v.x,this.y*v.y,this.z*v.z,this.w*v.w); }
  multiplyComponentsInPlace(v){ this.x*=v.x; this.y*=v.y; this.z*=v.z; this.w*=v.w; return this; }
